...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .qrbig{width:min(58vh,560px);height:auto;display:block;border-radius:28px;
      padding:28px;background:#14100f;border:1px solid #3b2b28;
      box-shadow:0 40px 90px -40px rgba(252,77,145,.25)}
