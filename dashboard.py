...
SLIDES = [
    {'act': 'holding', 'kicker': 'walk-in', 'title': "Background agents that won't get you fired", 'body': 'Want to cook along? Fork this repo now and open HANDOUT.md. Everyone else: sit tight, we start with a question. Here alone, or want to hang out after? Hit me up: 443-839-5151.', 'code': 'github.com/arcadeai-labs/daytona-background-agents\n\nfork it. clone it. open HANDOUT.md.'},
